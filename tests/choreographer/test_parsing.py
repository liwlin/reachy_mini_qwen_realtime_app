...
from reachy_mini_conversation_app.choreographer.parsing import ParseError, slugify, extract_move_source
...
def test_out_of_range_bpm_rejected():
    """Check out of range bpm rejected."""
